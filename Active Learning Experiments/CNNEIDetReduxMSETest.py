...
filepath_rand_mse = os.path.expanduser("~/EICNNRand_TauInvComparison_start100_MSEInd3.npy")
...
all_train_indices = np.load(os.path.expanduser('~/trainindices3.npy'))
filepath_rand_indices = os.path.expanduser("~/EICNNRand_TauInvComparison_start100_Ind3_TrInd.npy")
...
test_indices = np.load(os.path.expanduser('~/testindices3.npy'))
